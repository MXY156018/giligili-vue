			...
			load() {
				...
				APIs.getMe().then((res) => {
					...
					if (res.data.sex == "" || res.data.sex == "保密") {
						this.gsex = "https://giligili-mxy.oss-cn-hangzhou.aliyuncs.com/upload/avatars/suo.jpg";
					} else if (res.data.sex == "男") {
						this.gsex = "https://giligili-mxy.oss-cn-hangzhou.aliyuncs.com/upload/avatars/man.jpg";
						this.gsextxt = "绅士";
					} else {
						this.gsex = "https://giligili-mxy.oss-cn-hangzhou.aliyuncs.com/upload/avatars/women.jpg";
						this.gsextxt = "淑女";
					}
